...
public class CodeGenerator {
    ...
    private final String tableName = "ma_storage_type";//表名
    @Test
    public void generate() {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/myauthtest?serverTimezone=Asia/Shanghai", "myauthtest", "wTT6JnzfND8srBt8")
                ...
                .packageConfig(builder -> {
                    builder.parent("cn.daenx.myauth") // 设置父包名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude(tableName) // 设置需要生成的表名
                            ...
                            .entityBuilder()
                            .enableLombok()
                            .superClass("cn.daenx.myauth.base.po.baseEntity")
                            .idType(IdType.AUTO)
                            .enableChainModel()
                            .controllerBuilder()
                            .enableRestStyle()
